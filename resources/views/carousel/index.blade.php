            ...
            <div class="col-md-12">
                <div class="panel">
                    <div class="container-fluid" style="margin-top:20px">
                        <div class="row">
                            <div class="col-sm-5">
                                <h2 style="margin-top:0px">Data Carousel</h2>
                            </div>
                            <div class="col-sm-2">
                    ...
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr class="data-row">
                                    <td class="kode">{{ $carousel->kodec }}</td>
                                    <td class="gambar">
                                        {{ $carousel->gambar }}</td>
                                    <td class="keterangan"> Carousel ke-
                                        {{ $i }}</td>
                                    <td><button type="button" class="btn btn-warning btn-sm" id="edit-item"
                                            data-item-id="{{ $carousel->id }}">Edit</button>
                                        <a href="/carousel/{{ $carousel->id }}/delete" class="btn btn-danger btn-sm"
            ...
            <div class="modal-body">
                <form action="/carousel/create" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="tbkodec">Kode</label>
                        <input name="kodec" type="text" class="form-control" id="tbkodec" placeholder="Masukkan Kode"
                            required>
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="" method="POST" enctype="multipart/form-data" id="edit-form">
                    ...
                    <div class="form-group">
                        <label for="tbdestinasi">Gambar </label>
...
<script>
    $(document).ready(function () {
        ...
        $('#modaledit').on('show.bs.modal', function () {
            ...
            //edit action form
            $("#edit-form").attr('action', '/carousel/' + id + '/edit');
